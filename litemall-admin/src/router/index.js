...
export const asyncRouterMap = [
  ...
  },
  {
    ...
    children: [
      ...
      {
        path: 'joininactivity',
        component: () => import('@/views/user/joininactivity'),
        name: 'joininactivity',
        meta: {
          perms: ['GET /admin/Activity/joininactivity'],
          title: '活动统计',
          noCache: true
        }
      },
      {
        path: 'joinInCommonweal',
        component: () => import('@/views/user/joinInCommonweal'),
        name: 'joinInCommonweal',
        meta: {
          perms: ['GET /admin/Activity/joinInCommonweal'],
          title: '捐赠统计',
          noCache: true
        }
      },
